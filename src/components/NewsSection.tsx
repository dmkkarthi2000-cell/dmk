    ...
    <section className="py-12 md:py-20">
      <div className="container mx-auto px-4">
        {showHeader && (
          ...
          >
            <div>
              <h2 className="text-3xl md:text-4xl font-black tracking-tight">{t('section.news')}</h2>
              <p className="text-muted-foreground mt-1">{tr('Latest DMK and Tamil Nadu news')}</p>
            </div>
            <Link to="/news">
