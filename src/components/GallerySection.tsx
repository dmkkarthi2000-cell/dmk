    ...
    <section className="py-12 md:py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        {showHeader && (
          ...
          >
            <div>
              <h2 className="text-3xl md:text-4xl font-black tracking-tight">{t('section.gallery')}</h2>
              <p className="text-muted-foreground mt-1">{tr('Photos from events and campaigns')}</p>
            </div>
            <Link to="/gallery">
